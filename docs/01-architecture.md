...
[AutoVPN.ps1:1579](../AutoVPN.ps1), which starts the Windows Forms message
loop on that thread.

When you click **Connect VPN**, the button's click handler calls `Connect-VPN`
([AutoVPN.ps1:781](../AutoVPN.ps1)). That function does not return for as long
...
2. `DoEvents-Sleep` ([AutoVPN.ps1:729](../AutoVPN.ps1)), a replacement for
...
([AutoVPN.ps1:1106](../AutoVPN.ps1)), so every status change is a pump point too.
...
([AutoVPN.ps1:783](../AutoVPN.ps1)), and is cleared in a `finally` block.
...
the correct flag and exits ([AutoVPN.ps1:1583](../AutoVPN.ps1)). The relaunch
