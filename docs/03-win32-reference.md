...
([AutoVPN.ps1:776](../AutoVPN.ps1)) disambiguates by probing for an OK button
...
`Handle-SecurityAlert` ([AutoVPN.ps1:528](../AutoVPN.ps1)) matches on the button
...
([AutoVPN.ps1:519](../AutoVPN.ps1)), the Security Alert Yes button
([AutoVPN.ps1:566](../AutoVPN.ps1)), the auth OK button
([AutoVPN.ps1:692](../AutoVPN.ps1)), and the notification dismiss
([AutoVPN.ps1:792](../AutoVPN.ps1)). They route through `Win32::ClickHandle`,
